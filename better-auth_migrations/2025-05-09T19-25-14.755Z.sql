create table "user" ("id" text not null primary key, "name" text not null, "email" text not null unique, "emailVerified" boolean not null, "image" text, "createdAt" timestamp not null, "updatedAt" timestamp not null, "lang" text, "dni" text, "firstName" text, "lastName" text, "lastName2" text, "onboardingDone" boolean);
